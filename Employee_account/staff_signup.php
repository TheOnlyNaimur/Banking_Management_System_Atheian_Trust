    ...
    <header class="header">
      ...
      <nav class="main-nav">
        <ul class="main-nav-list">
          ...
          <li><a class="main-nav-link nav-cta" href="../Employee_account/staff_login.php">Sign In?</a></li>
          <li>
        ...
        <div class="container">
          <div class="cta">
            <div class="cta-text-box">
              ...
              <form class="cta-form" action="../Employee_account/staff_main_backend.php" method="POST">
                <div>
