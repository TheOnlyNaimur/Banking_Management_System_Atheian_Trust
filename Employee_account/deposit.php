    ...
    <header class="header">
      ...
      <nav class="main-nav">
        <ul class="main-nav-list">
          ...
          <li><a class="main-nav-link nav-cta" href="../Employee_account/withdraw.php">Withdraw</a></li>
          <li>
        ...
        <div class="container">
          <div class="cta">
            <div class="cta-text-box">
              <h2 class="heading-secondary"> Welcome to Deposit Page</h2>
              <p class="cta-text">
                Enter an account and deposit Money &darr;
              </p>
              
              <form action="../Employee_account/deposit.php" method="POST">
              <div class="bank account-info">
              <div><p class=info-text--2><?php echo $fund_status; ?></p></div>
              

                  <div><p class=info-text--2><?php echo $deposit_status; ?></p></div>
              ...
              <input class="btn btn--form" type="submit" value="Deposit in">
