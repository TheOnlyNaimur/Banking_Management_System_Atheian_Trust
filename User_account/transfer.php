        ...
        <div class="container">
          <div class="cta">
            <div class="cta-text-box">
              <h2 class="heading-secondary"> Welcome to Transfer Page</h2>
              <p class="cta-text">
                Transfer into you Money &darr;
              </p>
              
              <form action="../User_account/transfer.php" method="POST">
              <div class="bank account-info">
              <div><p class=info-text--2><?php echo $fund_status; ?></p></div>
              <div><p class=info-text--2><?php echo $recipient_status; ?></p></div>

                  <div><p class=info-text--2><?php echo $transfer_status; ?></p></div>
                <div><p class="info-text--1"><strong>Account Number Is:</strong> <?php echo htmlspecialchars($account_number);?></p></div> 
