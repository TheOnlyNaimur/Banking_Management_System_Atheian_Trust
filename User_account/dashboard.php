...
require "../User_account/dashboard_backend.php";
        ...
        <div class="container">
          <div class="cta">
            <div class="cta-text-box">
              ...
              <form action="../User_account/sign_in.php" method="#">
              <div class="bank account-info">
                ...
                <a class="btn btn--form back--1" type="button" target="_blank" href="../User_account/transfer.php">Transfer</a>
                <a class="btn btn--form back--1" type="button" target="_blank" href="../User_account/donate.php">Donate Now</a>
