...
require "../Employee_account/staff_dashboard_backend.php";
  ...
  <header class="header">
      ...
      <nav class="main-nav">
        <ul class="main-nav-list">
            ...
            <a class="main-nav-link nav-cta" href="../Employee_account/staff_login.php">Sign In</a>
            <a class="main-nav-link nav-cta" href="../Employee_account/staff_member_home.php">Log Out?</a>
          </li>
        </ul>
      </nav>
        ...
        <div class="container">
          <div class="cta">
            <div class="cta-text-box">
              <h2 class="heading-secondary">Congrats! You are signed in!</h2>
              <p class="cta-text">
                Now Here are the details of your Account &darr;
              </p>
              <form action="../Employee_account/staff_login.php" method="#">
              <div class="bank account-info">
                <div><p class="info-text--1"></p></div> 
                <div><p class="info-text"><strong>Welcome Account:</strong> <?php echo $_SESSION['account_number'];?></p></div>
                
                



                <p class="info-text--2"> Hope You remember your password!</p>
              </div>
                ...
                <a class="btn btn--form back--1"  href="../Employee_account/deposit.php" track="_blank">Deposit in</a>
                <a class="btn btn--form back--1"  href="../Employee_account/withdraw.php" track="_blank">Withdraw</a>
