    ...
    <header class="header">
      ...
      <nav class="main-nav">
        ...
        <li><a class="main-nav-link" href="../User_account/sign_up.php">How it works?</a></li>
          ...
          <li><a class="main-nav-link nav-cta" target="_blank" href="../Employee_account/Staff_member_home.php">Employee?</a></li>
          <li>
            <a class="main-nav-link nav-cta" href="../User_account/sign_up.php"
        ...
        <div class="container">
          <div class="cta">
            <div class="cta-text-box">
              ...
              <form class="cta-form" action="../User_account/sign_in_backend.php" method="POST">
